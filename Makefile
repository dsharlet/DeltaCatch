...
DEPS=delta_robot.h delta_hand.h delta_config.h vector2.h vector3.h arg_port.h nxtcam.h circular_array.h autodiff.h matrix.h debug.h trajectory.h camera.h
...
bin/delta_catch: obj/delta_catch.o obj/delta_robot.o obj/nxtcam.o obj/debug.o obj/delta_hand.o obj/trajectory.o
	mkdir -p bin
	$(CC) -o $@ $^ $(CFLAGS) $(CCFLAGS) $(LIBS)
